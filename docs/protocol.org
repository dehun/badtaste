...
* decore
** set new decore
   -> SetDecore(newBackgroundGuid = "10qwe", newFrameGuid = "20asd")
** get decore
   -> GetDecoreFor(targetUserGuid = "someguid")
   <- OnGotDecore(ownerUserGuid = "someguid", backgroundGuid = "10qwe", frameGuid = "20asd")
* mail
** send mail
...
** get user followers
   ...
   <- OnGotUserFollowers(ownerUserGuid = "someguid", currentFollower = "someguid2", formFollowers = ["someguid1", "someguid2", "someguid3"], rebuyPrice=100500)
