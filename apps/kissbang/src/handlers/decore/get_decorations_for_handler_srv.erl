...
%%%-------------------------------------------------------------------
-module(get_decorations_for_handler_srv).
...
%% API
-export([start_link/0]).
-export([handle_get_decorations_for/2]).
...
%%--------------------------------------------------------------------
init([]) ->
    handler_utils:register_handler(get_decorations_for, fun handle_get_decorations_for/2),
    {ok, #state{}}.
