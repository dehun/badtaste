...
%%%
%%% @end
%%% Created : 14 Aug 2012 by  <>
%%%-------------------------------------------------------------------
-module(get_vip_points_handler_srv).
-include("../../kissbang_messaging.hrl").
-behaviour(gen_server).

%% API
-export([start_link/0]).
-export([handle_get_vip_points/2]).
...
%%--------------------------------------------------------------------
init([]) ->
    handler_utils:register_handler(get_vip_points, fun handle_get_vip_points/2),
    {ok, #state{}}.
